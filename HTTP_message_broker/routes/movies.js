...
Router.get("/trending", async (req, res) => {
    ...
    const getTrendingMovies = {
        url: `http://${process.env.HOST}:4002/api/movies/trending`,
    };
...
Router.get("/topRatedRecommended", async (req, res) => {
    ...
    const getTopRated= {
        url: `http://${process.env.HOST}:4002/${process.env.MOVIE_PROCESSING_ROUTE}/topRatedRecommended`,
    };
...
Router.get("/movieDetails/:tmdbId", async (req, res) => {
    ...
    const getMovieDetailsTmdbIdRequest = {
        url: `http://${process.env.HOST}:4002/${process.env.MOVIE_PROCESSING_ROUTE}/movieDetails/${id}`,
    };
...
Router.get("/movieAutocomplete", async (req, res) => {
    ...
    const getAutocomplete = {
        url: `http://${process.env.HOST}:4002/${process.env.MOVIE_PROCESSING_ROUTE}/movieAutocomplete?q=${query}`,
    };
